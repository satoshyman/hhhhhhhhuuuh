  ...
  return (
    <div className="min-h-screen pb-20 bg-gradient-to-br from-green-50 via-emerald-50 to-green-50 px-4 pt-6">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 text-sm mt-1">Earn {adminConfig.referralProfit}% from each friend's mining</p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-3 mt-4 text-sm text-green-900">
          <p>💡 Share your link with friends to earn rewards when they start mining!</p>
        </div>
      </div>
                ...
                <div key={ref.id} className="bg-white rounded-xl shadow p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900">User {ref.id}</p>
                        <p className="text-xs text-gray-500">Mining: {ref.miningRate.toFixed(8)}/sec</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <p className="font-bold text-green-600">{earnings.toFixed(8)}</p>
                      <p className="text-xs text-gray-500">{(adminConfig.referralProfit)}% earnings</p>
                    </div>
                  </div>
                </div>
              );
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 text-center mt-6">
        <p className="text-blue-900 text-sm">
          🎯 <strong>Pro Tip:</strong> The more friends you refer, the more you earn! Start sharing now.
        </p>
      </div>
    </div>
  );
